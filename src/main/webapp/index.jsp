...
<div style="max-width:100%">
  <img class="mySlides"  src="logo001.png" >
  <img class="mySlides"  src="logo002.png" >
</div>
<script>
var myIndex = 0;
carousel();
...
<body>
  ...
  {
   %>
	<center><font color="blue" size="5">Form Submitted Successfully.</font></center>
   <%
  }
  %>
  <%
  ...
  {
	%>
	<center><font color="green" size="5">invalid data Try Again!</font></center>
	<%}
  %>
